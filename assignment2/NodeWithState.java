...
public class NodeWithState {
	...
	private int heuristic;        // the heuristic value of the state contained in the node 
	...
	public Vector<State> printSolution() {
		...
		while (cur.parent != null) {
			...
			switch (cur.action) {
				case 1: path.add(0, "Left"); break; 
				case 2: path.add(0, "Right"); break; 
				case 3: path.add(0, "Up"); break; 
				case 4: path.add(0, "Down"); break; 
			}
			cur = cur.parent;
		}
		return path; 
